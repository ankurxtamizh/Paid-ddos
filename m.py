...
bot = telebot.TeleBot('7360203245:AAGfamkor1yT1oUxsmxncXbuNIl7DJ6rxTE')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 👽𝐅𝐔𝐂𝐊𝐈𝐍𝐆 𝐒𝐓𝐀𝐑𝐓👽.\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: BGMI"
    bot.reply_to(message, response)
...
def handle_bgmi1(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "YOU DIDNT PURCHASED SUBSCRIPTION YET NIGGA.\nBUY FROM </> @L_RYUGA"
...
def welcome_start(message):
    ...
    response = f"𝐒𝐰𝐚𝐠𝐚𝐭 𝐡𝐚𝐢 𝐬𝐡𝐢𝐧𝐜𝐡𝐚𝐧 𝐤𝐞 𝐩𝐚𝐢𝐝 𝐛𝐨𝐭 𝐦𝐞 {user_name}! Feel Free to Explore.\nTry To Run This Command : /help\nWelcome To The World's Best Ddos Bot\nBy @TODO_V8/@L_RYUGA"
    bot.reply_to(message, response)
...
def broadcast_message(message):
    ...
    if user_id in admin_id:
        ...
        response = "NIGGA UR NOT ADMIN @TODO_V8."
